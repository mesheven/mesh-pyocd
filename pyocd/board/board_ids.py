...
BOARD_ID_TO_INFO = {
  ...
  # Board ID            Board Name              Target              Test Binary
    ...
    "2000": BoardInfo(  "MB00XX",               "stm32f051t8",        "l1_stm32f051.bin",     ),
    "2010": BoardInfo(  "MB2002/MB3002/MB4002", "stm32f415og",        "l1_stm32f415.bin",     ),
    ...
    "1080": BoardInfo(  "MB0017",               "lpc11u35",           "l1_lpc11u35.bin",      ),        
    }
